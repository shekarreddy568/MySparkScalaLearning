...
object WeatherDataAnalysis {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val input = spark.read
      ...
      .csv("hdfs://hadoop-fra-4.intern.beon.net:8020/tmp/data/Temperature.csv")
    input.printSchema()
    ...
    val x = input
      ...
      .toDF("Weather Station", "Date", "Observation Type", "Temperature")
      .filter($"Observation Type" === "TMIN")
      .drop("Date")
      .drop("Observation Type")
